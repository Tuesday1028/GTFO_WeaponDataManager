    ...
    internal class Patch_PlayerAmmoStorage
    {
        ...
        private static void PlayerAmmoStorage__GetStorageData__Postfix(PlayerAmmoStorage __instance, ref pAmmoStorageData __result)
        {
            ...
            if (WeaponDataManager.Instance.StoredAmmoBySlot.ContainsKey(InventorySlot.GearStandard))
            {
                ...
                __result.standardAmmo.Set(WeaponDataManager.Instance.StoredAmmoBySlot[InventorySlot.GearStandard] * WeaponDataManager.Instance.GetOriginAmmoMaxCapForWieldWeapon(InventorySlot.GearStandard), 500f);
            }
            if (WeaponDataManager.Instance.StoredAmmoBySlot.ContainsKey(InventorySlot.GearSpecial))
            {
                ...
                __result.specialAmmo.Set(WeaponDataManager.Instance.StoredAmmoBySlot[InventorySlot.GearSpecial] * WeaponDataManager.Instance.GetOriginAmmoMaxCapForWieldWeapon(InventorySlot.GearSpecial), 500f);
            }
        }
    }
}
