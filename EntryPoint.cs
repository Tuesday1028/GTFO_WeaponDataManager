...
namespace Hikaria.WeaponDataLoader
{
    ...
    public class EntryPoint : BasePlugin
    {
        public override void Load()
        {
            ...
            EnableFireModeSound = configFile.Bind("音效设置", "EnableSwitchFireModeSound", false, "启用开火模式音效");
            ...
            ClassInjector.RegisterTypeInIl2Cpp<WeaponDataLoadingManager>();
        ...
        private static ConfigFile configFile = new ConfigFile(WeaponDataLoadingManager.CONFIG_PATH, true);

        internal ConfigEntry<KeyCode> SwitchFireModeKey;

        internal ConfigEntry<KeyCode> ReloadCustomDataKey;

        internal ConfigEntry<bool> EnableFireModeSound;
